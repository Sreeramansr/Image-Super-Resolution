# -*- coding: utf-8 -*-
"""
Created on Thu Jan 26 17:47:15 2023
...
from app.format_image_module.SwinSR_Model.models.network_swin2sr import Swin2SR as net
from app.format_image_module.SwinSR_Model.utils import util_calculate_psnr_ssim as util
...
class ImageResolutionUpScaler:
    ...
    def load_model(self):
        ...
        if self.task == "real_sr":
            # use 'nearest+conv' to avoid block artifacts default embed_dim = 180, num_head= 6,depth=6
            model = net(
                upscale=self.scale,
                in_chans=3,
                img_size=64,
    ...
    def imageSuperResolution(self, image_path):
        # Decode the image string and convert it to a numpy array
